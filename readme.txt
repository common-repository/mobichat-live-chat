...
Tested up to: 4.2.2
Stable tag: 1.5
New! MobiChat is the only live chat built for mobile first. Get more Customers! Install the plugin and get live in 1 minute. Its so simple.
...
Your customers are on mobile devices and MobiChat is the only chat built for mobile first. Install the plugin and get live in 1 minute. Its so simple.
...
* Feature: Get Live with MobiChat in just 3 simple steps. The easiesy way to get chat on your blog by far.
...
3. Select Your Campaign Name from the Drop Down Campaign List.
4. Select a Color for your Chat Icon.
5. Click Add to My Wordpress Site.
6. DONE! its that Simple!

Please visit <a href="http://mobichat.com/wordpress-live-chat-plugin/" target="_blank">http://mobichat.com/wordpress-live-chat-plugin/</a> for more detailed instructions on how to setup this plugin. 
